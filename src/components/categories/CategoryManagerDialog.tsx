    ...
    <>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between gap-2">
              ...
              {hasPermission('categoryCreate') && (
                <Button onClick={startCreate} className="bg-primary hover:bg-primary/90 text-white">
              ...
              <div className="border rounded-md p-4 space-y-3">
                ...
                <div className="flex gap-2 justify-end">
                  ...
                  <Button
                    ...
                    className="bg-primary hover:bg-primary/90 text-white disabled:opacity-50 disabled:pointer-events-none">
      ...
      <AlertDialog open={!!inUseInfo} onOpenChange={(open) => !open && setInUseInfo(null)}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogAction onClick={() => setInUseInfo(null)} className="bg-card text-foreground hover:bg-muted border">
