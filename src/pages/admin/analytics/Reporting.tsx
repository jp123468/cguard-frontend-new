          ...
          <div className="grid gap-4 lg:grid-cols-3">
            ...
            <Section title="Asistencia" icon={<Clock size={16} className="text-amber-500" />}>
              <Stagger className="grid grid-cols-2 gap-3">
                {[
                  { label: "Horas trabajadas", value: data.attendance.hoursWorked, accent: "blue" as const },
                  { label: "Tardanzas", value: data.attendance.late, accent: "orange" as const },
                  { label: "Salidas tempranas", value: data.attendance.earlyDeparture, accent: "primary" as const },
                  { label: "Fuera de geocerca", value: data.attendance.geofenceViolations, accent: "red" as const },
                ].map((c) => (
