        ...
        <div className="flex flex-col md:flex-row justify-end gap-4">
          <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto items-center">
            <div className="relative w-full md:w-80">
              ...
              <Input
                placeholder="Buscar turno abierto"
                className="pl-9"
                value={searchQuery}
          ...
          <Table>
            <TableHeader className="bg-slate-50">
              <TableRow>
                ...
                <TableHead className="font-bold text-slate-700">Guardia requerido</TableHead>
                <TableHead className="font-bold text-slate-700">Solicitudes de guardias</TableHead>
              ...
              {shifts.length === 0 ? (
                ...
                shifts.map((shift) => (
                  <TableRow key={shift.id}>
                    ...
                    <TableCell>{shift.guardsRequired}</TableCell>
                    <TableCell>{shift.guardApplications}</TableCell>
                    <TableCell>
