          ...
          <Table>
            <TableHeader className="bg-slate-50">
              <TableRow>
                ...
                <TableHead className="font-bold text-slate-700">Fichado</TableHead>
                <TableHead className="font-bold text-slate-700">Desfichado</TableHead>
              ...
              {records.length === 0 ? (
                ...
                records.map((record) => (
                  <TableRow key={record.id}>
                    ...
                    <TableCell>{record.guard}</TableCell>
                    <TableCell>{record.startTime}</TableCell>
                    <TableCell>{record.endTime}</TableCell>
                    <TableCell>{record.clockedIn}</TableCell>
                    <TableCell>{record.clockedOut}</TableCell>
                    <TableCell>
