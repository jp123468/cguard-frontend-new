  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setVehicles([]);
        try { toast.error(String((e as any)?.message || (e as any)?.toString() || 'Error cargando veh�culos')); } catch {}
        try { telemetryService.log({ level: 'error', message: 'Error cargando veh�culos', details: e }); } catch {}
      }
    })();
      ...
      <PageContainer width="wide" className="p-6">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea rows={3} placeholder="Descripci�n de la ruta" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <Section title="Programar Ruta" contentClassName="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="md:col-span-2">
                          <FormLabel>Seleccionar D�as*</FormLabel>
                          <DropdownMenu>
            ...
            {/* Filtro de Vigilante eliminado seg�n solicitud */}
                ...
                <div className="flex items-center justify-between border-b bg-muted/30 px-4 py-3">
                  ...
                  <Select value={pointOrder} onValueChange={(v) => {
                    ...
                    <SelectTrigger className="w-48">
                      <SelectValue placeholder="Seleccionar">{pointOrder === 'distancia' ? 'Ordenar seg�n la distancia' : pointOrder === 'aleatorio' ? 'Ordenar de manera aleatoria' : undefined}</SelectValue>
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="distancia">Ordenar seg�n la distancia</SelectItem>
                  ...
                  <table className="min-w-full border-collapse text-left text-sm">
                    <thead className="bg-muted/30">
                      <tr className="border-b">
                        ...
                        <th className="px-4 py-3 font-semibold">Duraci�n (min)</th>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Seleccionar veh�culo*</FormLabel>
                  <Select value={field.value} onValueChange={field.onChange}>
                    <SelectTrigger>
                ...
                render={({ field }) => (
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <Label htmlFor="notify" className="cursor-pointer">
                      Enviar notificaci�n antes de las pasadas programadas
                    </Label>
                    <Select value={field.value} onValueChange={field.onChange}>
                ...
                render={({ field }) => (
                  <div className="flex items-center gap-3">
                    ...
                    <Label htmlFor="autocheck" className="cursor-pointer">
                      Registro autom�tico de entrada y salida en Puestos de Vigilancia seg�n geocerca
                    </Label>
                  </div>
                )}
              />
