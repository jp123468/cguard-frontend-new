...
export default function SettingsHome() {
  ...
  return (
    <AppLayout>
      <SettingsLayout navKey="configuracion" title={t("settings.configuracion.title", { defaultValue: "Configuración" })}>
        <div className="mx-auto max-w-6xl">
          {/* Hero */}
          <div className="relative overflow-hidden rounded-2xl border border-[#F0D9A0] bg-gradient-to-br from-[#FFF8E6] via-[#FFFDF7] to-white p-6 shadow-sm">
            <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-[#FFE9B8]/50 blur-2xl" />
            <div className="relative">
              ...
              <div className="relative mt-4 max-w-md">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-border bg-white/80 py-2.5 pl-10 pr-3 text-sm outline-none transition-colors focus:border-[#C8860A] focus:ring-2 focus:ring-[#C8860A]/20"
                />
              </div>
            </div>
          </div>
