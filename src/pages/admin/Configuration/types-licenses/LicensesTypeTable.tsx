  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
          ...
          <Button className="border border-primary text-primary bg-transparent hover:bg-primary/10 hover:text-primary transition duration-200 px-3" disabled={!idsChecked.length} onClick={() => onBulkDelete(idsChecked)}>
