...
type Props = {
  ...
  onCreate: () => void;
  onEdit: (row: SkillSetRow) => void;
  onToggleStatus: (row: SkillSetRow) => void;
  onBulkDelete: (ids: string[]) => void;
};

export default function SkillSetsTable({
  rows,
  total,
  page,
  pageSize,
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="relative flex-1 max-w-xl">
          ...
          <Input
            placeholder="Buscar conjunto de habilidades"
            className="pl-9"
            value={query}
              ...
              <TableRow>
                <TableCell colSpan={5}>
                  <EmptyState
                    ...
                    description="Crea tu primer conjunto de habilidades para comenzar."
