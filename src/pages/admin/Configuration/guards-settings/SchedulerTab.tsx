...
export default function SchedulerTab() {
  return (
    <Stagger className="grid gap-6">
      <Section title="Registro de turnos" icon={<CalendarClock />}>
        <div className="space-y-3">
          <RowCheck label="Permitir que los vigilantes registren entrada antes de la hora programada" />
          <RowCheck label="Permitir que los vigilantes intercambien turno sin aprobación" />
      ...
      <Section title="Disponibilidad y asignación" icon={<UserCheck />}>
        <div className="space-y-3">
          <RowCheck label="Permitir que los vigilantes establezcan disponibilidad" defaultChecked />
          <RowCheck label="Habilitar aprobación automática de horas de disponibilidad" />
          <RowCheck label="Asignar y confirmar automáticamente el turno abierto para el primer vigilante que acepte el turno" />
          <RowCheck label="Confirmar automáticamente los turnos publicados" />
          <LabeledSelect
            label="Permitir que el vigilante cancele el turno antes de"
            defaultValue="00:30"
            items={[
