      ...
      >
        ...
        {loading ? (
          ...
          <EmptyState
            icon={<FolderKanban />}
            title="Sin proyectos"
            description="No hay proyectos para este cliente todavía."
            action={
              <Button variant="brand" size="sm" onClick={() => { setEditingId(undefined); setOpenForm(true); }}>
